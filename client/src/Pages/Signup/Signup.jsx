...
export default class Signup extends Component {
    ...
    handleSubmit = async (event) => {
        ...
        if (this.state.usernameValid && this.state.passwordValid) {
            try {
                const response = await axios.post('/user/auth/signup', JSON.stringify({ email: this.state.email, fullname: this.state.fullname, username: this.state.username, password: this.state.password }));
